...
numPlotPoints = 100
time = np.linspace(0, Tf, numPlotPoints) # generates numPlotPoints (100) evenly spaced values between 0 and Tf (the final time of the trajectory).
position = np.zeros([numPlotPoints, 3]) # 2d array of dimensions (100 x 3)
velocity = np.zeros([numPlotPoints, 3]) # 2d array of dimensions (100 x 3)
acceleration = np.zeros([numPlotPoints, 3]) # 2d array of dimensions (100 x 3)
thrust = np.zeros([numPlotPoints, 1]) # 1d array of dimensions (100)
ratesMagn = np.zeros([numPlotPoints,1]) # 1d array of dimensions (100)
